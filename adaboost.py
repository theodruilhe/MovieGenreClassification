...
def adaboost(pca_df, random_state=25, lr=0.2, n_estimators=500):
    ...
    model = AdaBoostClassifier(
        n_estimators=500, learning_rate=0.2, random_state=random_state
    )
...
if __name__ == "__main__":
    ...
    model, accuracy = adaboost(pca_df, random_state=42, lr=0.2, n_estimators=500)
